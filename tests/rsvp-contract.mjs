...
assert.match(homepage, /style\.css\?v=20260704-gifts/);
...
assert.match(homepage, /Contributions can be made in either EUR or ZAR/);
...
assert.match(homepage, /Spain day timings/);
assert.match(homepage, /Bus picks up guests in Chiclana/);
assert.match(homepage, /Guest arrival at Finca Mesa Jard/);
assert.match(homepage, /South Africa day timings/);
assert.match(homepage, /Guest arrival at Mission House/);
assert.match(homepage, /Drinks reception and canapes/);
assert.match(homepage, /Dinner and speeches/);
assert.match(homepage, /Drinks and dancing/);
assert.match(homepage, /Sunset is expected around 19:55/);
assert.match(homepage, /Sunset is expected around 18:57/);
...
assert.match(style, /guest-layout\.css\?v=20260704-gifts/);
