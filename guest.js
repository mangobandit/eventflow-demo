(() => {
  ...
  const BUILT_IN_FAQS = [
    ...
    { title: "Will there be wedding day transport?", body: "Spain bus pickup is planned from 15:00 to 16:15 in Chiclana. South Africa bus pickup is planned from 15:00 to 16:15. Final pickup points depend on where guests stay, so please answer the guest check in transport questions promptly when they are sent." },
